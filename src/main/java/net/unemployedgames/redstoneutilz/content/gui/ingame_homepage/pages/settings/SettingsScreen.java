...
public class SettingsScreen extends Screen {
    ...
    public static SideBarButton mainHomePage_canShowFoolLogo;
    public static SideBarButton mainHomePage_canShowFestivalsLogo;
    public static SideBarButton ui_showsCursedGameTextures;
    public static SideBarButton save;
    ...
    public void init() {
        ...
        this.mainHomePage_canShowFoolLogo = addRenderableWidget(new SettingsToggle(width / 2 - 50, height / 2 - 50, 200, 22, AllSettings.CAN_SHOW_FOOL_LOGO));
        this.mainHomePage_canShowFestivalsLogo = addRenderableWidget(new SettingsToggle(width / 2 - 50, height / 2 - 25, 200, 22, AllSettings.CAN_SHOW_FESTIVALS_LOGO));
        this.ui_showsCursedGameTextures = addRenderableWidget(new SettingsToggle(width / 2 - 50, height / 2 - 0, 200, 22, AllSettings.UI_CURSED_GAME_TEXTURES));
        this.save = addRenderableWidget(new SideBarButton(width / 2 - 50, height - 10, 200, 22, Component.translatable("ui.redstoneutilz.misc.done"), new SideBarButton.SideBarImg(AllIcons.SETTINGS, 16, 16), pButton -> Handler.reactToSidebarButtonClick(Handler.SidebarButtonType.MODRINTH, Minecraft.getInstance())));
        // Animate
