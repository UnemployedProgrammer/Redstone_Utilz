...
import net.unemployedgames.redstoneutilz.content.gui.block.RenamerBlockConfigurationScreen;
...
public class ClientHooks {
    ...
    public static void openRenamerBlockConfigurationScreen(BlockPos pos) {
        //Minecraft.getInstance().setScreen(new CopyCatButtonConfigurationScreen(pos));
        Minecraft.getInstance().setScreen(new RenamerBlockConfigurationScreen(pos));
    }
